...
class PropertyManagementSale(models.Model):
    ...
    size= models.IntegerField('size', blank=True, default=0, null=True)
    is_listed= models.BooleanField('is_listed', default=True, db_index=True)
    ...
    listing_score=models.IntegerField('Listing Score', default=0, blank=False, null=False, db_index=True)
